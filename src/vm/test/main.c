...
MunitTest tests[] = {{"/vm__create", vm__create_test, NULL, NULL, MUNIT_TEST_OPTION_NONE, NULL},
...
static const MunitSuite suite = {"/argo-vm", tests, NULL, 1, MUNIT_SUITE_OPTION_NONE};

int main(int argc, char *const *argv) { return munit_suite_main(&suite, (void *)"argo-vm", argc, argv); }
