...
MunitTest tests[] = {
    ...
    {"/vm__op_create", vm__op_create_test, NULL, NULL, MUNIT_TEST_OPTION_NONE,
     NULL},
    {"/vm__op_free", vm__op_free_test, NULL, NULL, MUNIT_TEST_OPTION_NONE,
     NULL},
    {NULL, NULL, NULL, NULL, MUNIT_TEST_OPTION_NONE, NULL}};

static const MunitSuite suite = {"/argo-vm", tests, NULL, 1,
